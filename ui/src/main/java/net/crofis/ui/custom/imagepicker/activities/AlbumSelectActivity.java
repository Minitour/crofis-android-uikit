...
public class AlbumSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //setSupportActionBar(toolbar);
        ...
        final String color = getIntent().getStringExtra(Constants.INTENT_EXTRA_COLOR);
        ...
        if (actionBar != null) {
            ...
            if(color!=null) actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor(color)));
        }
