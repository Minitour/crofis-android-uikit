...
import net.crofis.ui.custom.imagepicker.adapters.CustomImageSelectAdapter;
...
public class ImageSelectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Constants.limit>1) SINGLE_MODE = false;
        else SINGLE_MODE = true;
        ...
        if (actionBar != null) {
            ...
            if(!SINGLE_MODE)actionBar.setTitle(R.string.image_view);
            else actionBar.setTitle(R.string.image_view_single);
        }
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(!SINGLE_MODE) actionMode.setTitle(countSelected + " " + getString(R.string.selected));
                else actionMode.setTitle(""+getString(R.string.selected_single));
    ...
    private void toggleSelection(int position) {
        if (!images.get(position).isSelected && countSelected >= Constants.limit) {
            if(!SINGLE_MODE)Toast.makeText(getApplicationContext(), String.format(getString(R.string.limit_exceeded), Constants.limit), Toast.LENGTH_SHORT).show();
            return;
        }
